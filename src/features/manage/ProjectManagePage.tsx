...
export default function ProjectManagePage() {
  ...
  function saveProject(project: Project) { repository.save(project); setProjects(repository.list()); setEditingProject(null) }
